...
function SocialBar({ location, fixed, desktopOnly, socials }: SocialBarProps) {
    ...
    return (
        <div
            className={`${conditionalClasses} text-secondary-text dark:text-dark-secondary-text w-12 bottom-0 flex flex-col items-center z-20 after:content-[''] after:left-2/4 after:block after:w-0.5 after:h-24 after:bg-secondary-text after:dark:text-dark-secondary-text`}
        >
            {socials.map(social => (
